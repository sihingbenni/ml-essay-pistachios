...
columnsep=10pt, % Space between text columns (in twocolumn mode)
...
\newcommand{\mytitle}{Optimierung der Klassifizierung von Pistazienarten durch Hyperparameter-Anpassungen in K-NN und SVM}
...
\chead[]{\me}
\ohead[\today]{\today}
\cfoot[Hausarbeit Maschinelles Lernen]{Hausarbeit Maschinelles Lernen}
...
\begin{document}
	...
	\input{preamble/eigenständigkeits_erklärung}\pagenumbering{Roman}
	\input{preamble/ki_erklärung}
	\newpage
	\input{preamble/abstract}\pagenumbering{arabic}
	
	\begin{multicols}{2}
		\input{sections/introduction}
		\input{sections/main_section}
